...
const Chetna = () => {
  return (
    ...
    <div>   <img  className='img1' src={pic6} alt="" /></div>
    <div> <h3 className='drtext'>Dr.Chetna</h3> <br />
    
     <h5  className='drtext1'>Associate Director - Radiologist and Consultant, Lasers and Aesthetic Medicines </h5>
     <br />
     <h6  className='drtext1'> Radiologist</h6>
     </div>
